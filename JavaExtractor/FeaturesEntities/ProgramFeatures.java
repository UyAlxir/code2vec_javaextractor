...
public class ProgramFeatures {
	...
	public void addFeature(Property source, String path, Property target, String lines) {
		ProgramRelation newRelation = new ProgramRelation(source, target, path, lines);
